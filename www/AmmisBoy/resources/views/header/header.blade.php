										...
										<div class="navbar-wrap">
											<div class="navbar-header">
												...
												<a class="navbar-brand" href="./">
													<h4>Ammi's Little Boy</h4>
													<!-- <img class="logo" alt="Ammi's Little Boy" src="images/logo.png">
												...
												<ul class="nav navbar-nav primary-nav">
													...
													<li class="menu-item-has-children megamenu megamenu-fullwidth dropdown">
														...
														<ul class="dropdown-menu">
															...
															<li class="mega-col-3">
																<h3 class="megamenu-title">trousers <span class="caret"></span></h3>
																<ul class="dropdown-menu">
																	<li><a href="shop-fullwidth.html">Long</a></li>
																	<li><a href="shop-detail-2.html">Short</a></li>
